...
interface SystemCatalogLinkPageProps {
  /** Title text to display in the header. Set to null or undefined to hide the title. */
  title?: string | null;
...
export default function SystemCatalogLinkPage({
  title = "시스템 카탈로그",
